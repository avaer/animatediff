# curl -X POST 'http://127.0.0.1:1289/animatediff' \
#     -F 'prompt=close up shot, anime girl in a summer dress walking through abandoned neotokyo city, symbols, lush ancient jungle nature overgrowth, colorful' \
